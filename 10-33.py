...
class MainGUI:
    def display(self):
        ...
        for i in range(26):
            ...
            self.canvas.create_text(10+i*barWidth+5,height-5,text = chr((i+ord('a'))),tags='histogram')
            self.canvas.create_text(10+i*barWidth+5,height-(height-10)*counts[i]/maxCount-5,
